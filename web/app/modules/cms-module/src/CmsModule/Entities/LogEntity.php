 ...
 * Class LogEntity
 *
 * @ORM\Entity(repositoryClass="CmsModule\Repositories\LogRepository")
 * @ORM\Table(name="log", indexes={@ORM\Index(name="created_idx", columns={"inserted"})})
...
class LogEntity
{
    ...
    /**
     * @var UserEntity
     * @ORM\ManyToOne(targetEntity="UserEntity", cascade={"persist"})
