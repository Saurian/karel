...
ALTER TABLE users ADD group_id INT DEFAULT NULL;
...
ALTER TABLE medium DROP FOREIGN KEY `FK_C67345B75DA0FB8`;
DROP INDEX IDX_C67345B75DA0FB8 ON medium;
ALTER TABLE medium DROP template_id;

ALTER TABLE campaign DROP FOREIGN KEY `FK_1F1512DD5DA0FB8`;
DROP INDEX IDX_1F1512DD5DA0FB8 ON campaign;
ALTER TABLE campaign DROP template_id;

DROP TABLE `identity`, `template`, `templates_users`;
